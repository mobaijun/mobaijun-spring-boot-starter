 ...
 */
package com.mobaijun.oss.properties;
...
public class OssProperties {
     ...
     * </p>
     * <p>
     * 如将<code>endpoint</code>设置为<a href="http://192.168.1.3:9000">...</a>，<code>domain</code>设置为<code>http://example.com</code>,就可以在内部通过http://192.168.1.3:9000上传删除等文件操作，外部通过http://example.com访问，
     * </p>
     * <p>
     ...
     * 形如:<a href="http://s3endpoint/BUCKET">...</a>
     * <p>
     * 例如，如果你要把photo.jpg存放在region为us-west-2，bucket为images的bucket中，你可用以下的方式来访问这个文件：
     * </p>
     * <p>
     * <a href="http://s3-us-west-2.amazonaws.com/images/photo.jpg">...</a>
     * </p>
     *
     * <p>
     * <a href="http://s3.us-west-2.amazonaws.com/images/photo.jpg">...</a>
     ...
     * </p>
     * <p>
     * <a href="http://s3.amazonaws.com/images/photo.jpg">...</a>
     * <p>
     * </p>
     * <p>
     * <a href="http://s3-external-1.amazonaws.com/images/photo.jpg">...</a>
     * </p>
     * <p>
     ...
     * URL中，bucket的名称成为了subdomain:<a href="http://BUCKET.s3endpoint">...</a>
     * <p>
     * 例如，如果你要把photo.jpg存放在region为us-west-2，bucket为images的bucket中，你可用以下的方式来访问这个文件：
     * </p>
     * <p>
     * <a href="http://images.s3-us-west-2.amazonaws.com/photo.jpg">...</a>
     * </p>
     * <p>
     * <a href="http://images.s3.us-west-2.amazonaws.com/photo.jpg">...</a>
     * </p>
     ...
     * </p>
     * <p>
     * <a href="http://images.s3.amazonaws.com/photo.jpg">...</a>
     * </p>
     * <p>
