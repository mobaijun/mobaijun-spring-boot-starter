 ...
 */
package com.mobaijun.core.strategy;

import com.mobaijun.core.strategy.annotation.StrategyComponent;
import com.mobaijun.core.strategy.annotation.StrategyInterface;
...
/**
 * Description: [用于获取Spring上下文中的策略实例，并解析该实例所实现的策略类型。]
 * Author: [mobaijun]
