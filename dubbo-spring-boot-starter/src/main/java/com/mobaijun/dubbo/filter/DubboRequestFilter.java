package com.mobaijun.dubbo.filter;
...
public class DubboRequestFilter implements Filter {
     ...
     * @return 调用结果
     * @throws org.apache.dubbo.rpc.RpcException 如果调用过程中发生异常
     */
    @Override
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if (result.hasException() && invoker.getInterface().equals(GenericService.class)) {
            ...
            if (properties.getLogLevel() == RequestLogEnum.INFO) {
                ...
                log.info("DUBBO - 服务响应: {},SpendTime=[{}ms],Response={}", baselog, elapsed, JsonUtil.toJsonString(new Object[]{result.getValue()}));
            }
        }
        return result;
    }
